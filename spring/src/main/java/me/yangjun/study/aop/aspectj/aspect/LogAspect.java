package me.yangjun.study.aop.aspectj.aspect;
...
public class LogAspect {
     ...
     * 声明切点
     */
    @Pointcut("execution(* me.yangjun.study.aop.aspectj.service..*.show(..))")
    public void pShow() {}

    @Pointcut(
        value = "execution(* me.yangjun.study.aop.aspectj.service..*.showWithArgs(..)) && args(p1, p2)",
        argNames = "p1, p2")
    public void pShowWithArgs(String p1, int p2) {}

    @Pointcut(
        value = "execution(* me.yangjun.study.aop.aspectj.service..*.showWithException(..)) && args(p1, p2)",
        argNames = "p1, p2")
